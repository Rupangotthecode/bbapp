...
const AdminControl = ({ navigation }) => {
    ...
    useEffect(() => {
        ...
        if (!gameDetails.tossWinner.winner) {
            ...
            // Show server modal after preparation is complete
    ...
    const handleEndSet = () => {
        dispatch(endSet(gameDetails._id));
    ...
    return (
        <View style={ACStyleSheet.ACmainContainer}>
            <View style={ACStyleSheet.ACupperContainer}>
                <Scorebar gameDetails={gameDetails} setNo={0} showModal={showInfoModal} />
            </View>
                ...
                <View style={{ position: "absolute", width: "100%", height: "100%" }}>
                    <PaperProvider>
                        ...
                        <Portal>
                            ...
                            <ServerModal gameId={gameDetails._id} teamName={gameDetails.team2Name} showServerModal={showServerModalTeam2} servers={initialSelection ? gameDetails.sets[setNumber]?.team1Main : servers} setShowServerModal={setShowServerModalTeam2} initialSelection={initialSelection} />
                        </Portal>
                        <Portal>
